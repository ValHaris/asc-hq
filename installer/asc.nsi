...
Name "Advanced Strategic Command 2.3.73.16"

; The file to write
OutFile "ASC-2.3.73.16-Install.exe"
...
Section "ASC main program (required)"
  ...
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\Advanced Strategic Command" "DisplayName" "Advanced Strategic Command 2.3.73.16"
