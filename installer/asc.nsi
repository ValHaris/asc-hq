...
Name "Advanced Strategic Command 2.3.79.1"

; The file to write
OutFile "ASC-2.3.79.1-Install.exe"
...
Function registerASC
  ...
  ${Else}
      ...
      WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\Advanced Strategic Command" "DisplayName" "Advanced Strategic Command 2.3.79.1"
