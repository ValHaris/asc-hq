...
Name "Advanced Strategic Command 2.1.90.9"

; The file to write
OutFile "ASC-2.1.90.9-Install.exe"
...
Section "ASC main program (required)"
  ...
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\Advanced Strategic Command" "DisplayName" "Advanced Strategic Command 2.1.90.9"
