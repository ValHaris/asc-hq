...
Name "Advanced Strategic Command 2.7.127.2"

; The file to write
OutFile "ASC-2.7.127.2-Install.exe"
...
Function registerASC
  ...
  ${Else}
      ...
      WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\Advanced Strategic Command" "DisplayName" "Advanced Strategic Command 2.7.127.2"
