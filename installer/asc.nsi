...
Name "Advanced Strategic Command 2.4.0.91"

; The file to write
OutFile "ASC-2.4.0.91-Install.exe"
...
Function registerASC
  ...
  ${Else}
      ...
      WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\Advanced Strategic Command" "DisplayName" "Advanced Strategic Command 2.4.0.91"
