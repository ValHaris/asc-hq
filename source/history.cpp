   ...
   { void *with1 = &map; 
      ...
      for (i = 0; i <= 8; i++) 
         if (with1->player[i].existent == true) { void *with2 = &with1->player[i]; 
            ar->player[i] = malloc(sizeof(*ar->player[i]));
            ar->player[i]->vehicle = 0; 
            ar->player[i]->buildings = 0; 
            ar->player[i]->material = 0; 
            ar->player[i]->plus.material = 0; 
            ar->player[i]->energy = 0; 
            ar->player[i]->plus.energy = 0; 
            ar->player[i]->sprit = 0; 
            ar->player[i]->plus.fuel = 0; 
            ...
            if (firstbuilding != NULL) { 
               ...
               do { 
                  if (ab != NULL) { 
                     inc(ar->player[i]->buildings); 
                     inc(ar->player[i]->material,ab->material); 
                     inc(ar->player[i]->plus.material,ab->plus.material); 
                     inc(ar->player[i]->energy,ab->energy); 
                     inc(ar->player[i]->plus.energy,ab->plus.energy); 
                     inc(ar->player[i]->sprit,ab->sprit); 
                     inc(ar->player[i]->plus.fuel,ab->plus.fuel); 
