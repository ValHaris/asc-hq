...
static swig_lua_attribute swig_ActionResult_cls_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_ActionResult_cls_methods[] = {
    {0,0}
};
static swig_lua_const_info swig_ActionResult_cls_constants[] = {
    {0,0,0,0,0,0}
};
static swig_lua_class *swig_ActionResult_bases[] = {0};
static const char *swig_ActionResult_base_names[] = {0};
static swig_lua_class _wrap_class_ActionResult = { "ActionResult", &SWIGTYPE_p_ActionResult,0, swig_delete_ActionResult, swig_ActionResult_methods, swig_ActionResult_attributes, { "ActionResult", swig_ActionResult_cls_methods, swig_ActionResult_cls_attributes, swig_ActionResult_cls_constants }, swig_ActionResult_bases, swig_ActionResult_base_names };
