...
static int _wrap_GameMap_getField(lua_State* L) {
  ...
  if (argc == 2) {
    ...
    if (_v) {
      {
        void *ptr;
        if (lua_isuserdata(L,argv[1])==0 || SWIG_ConvertPtr(L,argv[1], (void **) &ptr, SWIGTYPE_p_MapCoordinate, SWIG_POINTER_NO_NULL)) {
          _v = 0;
        } else {
          _v = 1;
        }
...
static int _proxy__wrap_new_FieldVector(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_FieldVector);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
...
static swig_lua_method swig_FieldVector_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_FieldVector_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_FieldVector_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_FieldVector_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_FieldVector_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_FieldVector_Sf_SwigStatic = {
    "FieldVector",
    swig_FieldVector_Sf_SwigStatic_methods,
    swig_FieldVector_Sf_SwigStatic_attributes,
    swig_FieldVector_Sf_SwigStatic_constants,
    swig_FieldVector_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_FieldVector_bases[] = {0};
static const char *swig_FieldVector_base_names[] = {0};
static swig_lua_class _wrap_class_FieldVector = { "FieldVector", "FieldVector", &SWIGTYPE_p_FieldVector,_proxy__wrap_new_FieldVector, swig_delete_FieldVector, swig_FieldVector_methods, swig_FieldVector_attributes, &swig_FieldVector_Sf_SwigStatic, swig_FieldVector_meta, swig_FieldVector_bases, swig_FieldVector_base_names };
...
static int _proxy__wrap_new_EditingEnvironment(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_EditingEnvironment);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
...
static swig_lua_method swig_EditingEnvironment_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_EditingEnvironment_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_EditingEnvironment_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_EditingEnvironment_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_EditingEnvironment_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_EditingEnvironment_Sf_SwigStatic = {
    "EditingEnvironment",
    swig_EditingEnvironment_Sf_SwigStatic_methods,
    swig_EditingEnvironment_Sf_SwigStatic_attributes,
    swig_EditingEnvironment_Sf_SwigStatic_constants,
    swig_EditingEnvironment_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_EditingEnvironment_bases[] = {0};
static const char *swig_EditingEnvironment_base_names[] = {0};
static swig_lua_class _wrap_class_EditingEnvironment = { "EditingEnvironment", "EditingEnvironment", &SWIGTYPE_p_EditingEnvironment,_proxy__wrap_new_EditingEnvironment, swig_delete_EditingEnvironment, swig_EditingEnvironment_methods, swig_EditingEnvironment_attributes, &swig_EditingEnvironment_Sf_SwigStatic, swig_EditingEnvironment_meta, swig_EditingEnvironment_bases, swig_EditingEnvironment_base_names };
...
static int _wrap_writeMapImageToFile(lua_State* L) {
  int SWIG_arg = 0;
  GameMap *arg1 = (GameMap *) 0 ;
  std::string *arg2 = 0 ;
  bool arg3 ;
  ...
  SWIG_check_num_args("writeMapImageToFile",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("writeMapImageToFile",1,"GameMap *");
  if(!lua_isstring(L,2)) SWIG_fail_arg("writeMapImageToFile",2,"std::string const &");
  if(!lua_isboolean(L,3)) SWIG_fail_arg("writeMapImageToFile",3,"bool");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_GameMap,0))){
    SWIG_fail_ptr("writeMapImageToFile",1,SWIGTYPE_p_GameMap);
  }
  
  temp2.assign(lua_tostring(L,2),lua_rawlen(L,2)); arg2=&temp2;
  arg3 = (lua_toboolean(L, 3)!=0);
  writeMapImageToFile(arg1,(std::string const &)*arg2,arg3);
...
static int _wrap_superviseGame(lua_State* L) {
  int SWIG_arg = 0;
  std::string *arg1 = 0 ;
  std::string *arg2 = 0 ;
  std::string temp1 ;
  ...
  SWIG_check_num_args("superviseGame",2,2)
  if(!lua_isstring(L,1)) SWIG_fail_arg("superviseGame",1,"std::string const &");
  if(!lua_isstring(L,2)) SWIG_fail_arg("superviseGame",2,"std::string const &");
  temp1.assign(lua_tostring(L,1),lua_rawlen(L,1)); arg1=&temp1;
  temp2.assign(lua_tostring(L,2),lua_rawlen(L,2)); arg2=&temp2;
  result = (GameMap *)superviseGame((std::string const &)*arg1,(std::string const &)*arg2);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_GameMap,0); SWIG_arg++; 
  return SWIG_arg;
...
static swig_lua_method swig_SwigModule_methods[]= {
    ...
    { "writeMapImageToFile", _wrap_writeMapImageToFile},
    { "superviseGame", _wrap_superviseGame},
    {0,0}
};
...
&_wrap_class_FieldVector,
&_wrap_class_EditingEnvironment,
    0
};
