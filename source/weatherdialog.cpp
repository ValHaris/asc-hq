...
WeatherDialog::WeatherDialog() :  ASC_PG_Dialog(NULL, PG_Rect( 100, 50, xsize, ysize ), "Weather Configuration", SHOW_CLOSE ) {
    ...
    fallOutButton->sigClick.connect(sigc::mem_fun( *this, &WeatherDialog::editFallOut ));
    ...
    windSpeedButton->sigClick.connect(sigc::mem_fun( *this, &WeatherDialog::editWindSpeed));
    ...
    windDirectionButton->sigClick.connect(sigc::mem_fun( *this, &WeatherDialog::editWindDirection));
    ...
    eventAreasButton->sigClick.connect(sigc::mem_fun( *this, &WeatherDialog::editEventAreas));
    ...
    eventWindChangesButton->sigClick.connect(sigc::mem_fun( *this, &WeatherDialog::editEventWindChanges));



    //Ok and Cancel Button
    (new PG_Button(this, PG_Rect(30, Height()-40, (Width()-70)/2, 30), "OK", 100))->sigClick.connect(sigc::mem_fun( *this, &WeatherDialog::buttonEvent ));
    (new PG_Button(this, PG_Rect(Width()/2+5, Height()-40, (Width()-70)/2, 30), "Cancel", 101))->sigClick.connect(sigc::mem_fun( *this, &WeatherDialog::closeWindow ));
...
EventAreasDialog::EventAreasDialog() : ASC_PG_Dialog(NULL, PG_Rect( 100, 100, xSize, ySize ), "Edit eventdriven Areas", SHOW_CLOSE ) {
    ...
    addButton->sigClick.connect(sigc::mem_fun( *this, &EventAreasDialog::buttonAdd ));

    //remove Button
    removeButton = new PG_Button(this, PG_Rect(Width() - (xPos1 + 70), yPosButtons, 70, 35), "Remove", 90);
    removeButton->sigClick.connect(sigc::mem_fun( *this, &EventAreasDialog::buttonRemove ));

    //Ok and Cancel Button
    (new PG_Button(this, PG_Rect((Width()- GuiDimension::getButtonWidth())/2, Height()-40, GuiDimension::getButtonWidth() , 30), "OK", 100))->sigClick.connect(sigc::mem_fun( *this, &EventAreasDialog::buttonEvent ));
    //(new PG_Button(this, PG_Rect(Width()/2+5, Height()-40, (Width()-70)/2, 30), "Cancel", 101))->sigClick.connect(sigc::mem_fun( *this, &EventAreasDialog::closeWindow ));
...
EventWindChangesDialog::EventWindChangesDialog() : ASC_PG_Dialog(NULL, PG_Rect( 100, 100, xSize, ySize ), "Edit eventdriven WindChange", SHOW_CLOSE ) {
    ...
    addButton->sigClick.connect(sigc::mem_fun( *this, &EventWindChangesDialog::buttonAdd ));

    //remove Button
    removeButton = new PG_Button(this, PG_Rect(Width() - (xPos1 + 50), yPosButtons, 50, 35), "Remove", 90);
    removeButton->sigClick.connect(sigc::mem_fun( *this, &EventWindChangesDialog::buttonRemove ));

    //Ok and Cancel Button
    (new PG_Button(this, PG_Rect((Width()-GuiDimension::getButtonWidth())/2, Height()-40, GuiDimension::getButtonWidth(), 30), "OK", 100))->sigClick.connect(sigc::mem_fun( *this, &EventWindChangesDialog::buttonEvent ));
    //(new PG_Button(this, PG_Rect(Width()/2+5, Height()-40, (Width()-70)/2, 30), "Cancel", 101))->sigClick.connect(sigc::mem_fun( *this, &EventWindChangeDialog::closeWindow ));
...
AddWindChangeDialog::AddWindChangeDialog(EventWindChangesDialog* ewcd):  ASC_PG_Dialog(ewcd, PG_Rect( 0, 0, xSize, ySize ), "Add Weather Area", SHOW_CLOSE ) {
    ...
    //Ok and Cancel Button
    (new PG_Button(this, PG_Rect(30, Height()-40, (Width()-70)/2, 30), "OK", 100))->sigClick.connect(sigc::mem_fun( *this, &AddWindChangeDialog::buttonEvent ));
    (new PG_Button(this, PG_Rect(Width()/2+5, Height()-40, (Width()-70)/2, 30), "Cancel", 101))->sigClick.connect(sigc::mem_fun( *this, &AddWindChangeDialog::closeWindow ));
...
AddWeatherAreaDialog::AddWeatherAreaDialog(EventAreasDialog* ead):  ASC_PG_Dialog(ead, PG_Rect( 0, 0, xSize, ySize ), "Add Weather Area", SHOW_CLOSE ) {
    ...
    //Ok and Cancel Button
    (new PG_Button(this, PG_Rect(30, Height()-40, (Width()-70)/2, 30), "OK", 100))->sigClick.connect(sigc::mem_fun( *this, &AddWeatherAreaDialog::buttonEvent ));
    (new PG_Button(this, PG_Rect(Width()/2+5, Height()-40, (Width()-70)/2, 30), "Cancel", 101))->sigClick.connect(sigc::mem_fun( *this, &AddWeatherAreaDialog::closeWindow ));
...
void ChanceSettingsDialog::buildUpForm(const vector<string>& labelVec) {
    ...
    note->SetSizeByText();
    //Ok and Cancel Button
    (new PG_Button(this, PG_Rect(30, Height()-40, (Width()-70)/2, 30), "OK", 100))->sigClick.connect(sigc::mem_fun( *this, &ChanceSettingsDialog::buttonEvent ));
    (new PG_Button(this, PG_Rect(Width()/2+5, Height()-40, (Width()-70)/2, 30), "Cancel", 101))->sigClick.connect(sigc::mem_fun( *this, &ChanceSettingsDialog::closeWindow ));
