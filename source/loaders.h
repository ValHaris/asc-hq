...
//     $Id: loaders.h,v 1.32 2005-03-30 17:19:03 mbickel Exp $
...
const int actsavegameversion  = 0xff42;
const int minsavegameversion  = 0xff31;
const int actmapversion       = 0xfe30;
const int minmapversion       = 0xfe24;
const int actnetworkversion   = 0x0014;
