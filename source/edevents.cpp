...
void   tgeteventid::get_text(word nr) //gibt in txt den string zurck
{
   word    count;
   pevent  e;
...
void   tgettechnologyid::get_text(word nr) //gibt in txt den string zurck
{
...
void   teventsel::get_text(word nr) //gibt in txt den string zurck
{
   word    count;
   pevent  e;
