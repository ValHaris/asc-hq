...
{
   this->insert = insert;
   AddStandardButton("OK")->sigClick.connect( sigc::mem_fun( *this, &ImportBI3MapDialog::ok ));
   AddStandardButton("Cancel")->sigClick.connect( sigc::mem_fun( *this, &ImportBI3MapDialog::cancel ));
